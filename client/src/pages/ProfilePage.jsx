...
const ProfilePage = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-extrabold text-slate-900 dark:text-white tracking-tight">Account Profile & Security</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Profile Card */}
        <div className="bg-white dark:bg-slate-900/70 p-6 rounded-3xl border border-slate-200/80 dark:border-slate-800/80 shadow-sm text-center flex flex-col items-center backdrop-blur-xl">
          <div className="relative mb-4">
            {user?.avatar ? (
              <img
                src={user.avatar}
                alt={user.name}
                className="w-24 h-24 rounded-2xl object-cover ring-4 ring-brand-100 dark:ring-brand-900 shadow-md"
              />
            ) : (
          ...
          <div className="w-full pt-6 mt-6 border-t border-slate-100 dark:border-slate-800 text-left text-xs space-y-2 text-slate-600 dark:text-slate-300">
        ...
        <div className="md:col-span-2 space-y-6">
          {/* Personal Info Form */}
          <div className="bg-white dark:bg-slate-900/70 p-6 sm:p-8 rounded-3xl border border-slate-200/80 dark:border-slate-800/80 shadow-sm backdrop-blur-xl">
            ...
            <form onSubmit={handleProfileSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  disabled
                  value={user?.email || ''}
                  className="w-full rounded-xl border border-slate-200 dark:border-slate-800 p-2.5 text-xs text-slate-400 bg-slate-50 dark:bg-slate-800/50 cursor-not-allowed"
                />
              </div>
